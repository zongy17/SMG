...
#define SHIFT(oi, oj, ok) 13 + (ok) + (oi) * 3 + (oj) * 9 
    ...
    for (idx_t K = ckbeg; K < ckend; K++) {
		if (CHECK_BDR(I - 1,J - 1,K - 1)) {// ingb=0
			...
			{// u_coord=(2*I - 1,2*J - 1,2*K - 1)
				...
				tmp += 0.0156250 * ptr[SHIFT(0,0,0)];
				tmp += 0.0468750 * ptr[SHIFT(0,0,-1)];
				tmp += 0.0468750 * ptr[SHIFT(0,-1,0)];
				tmp += 0.1406250 * ptr[SHIFT(0,-1,-1)];
				tmp += 0.0468750 * ptr[SHIFT(-1,0,0)];
				tmp += 0.1406250 * ptr[SHIFT(-1,0,-1)];
				tmp += 0.1406250 * ptr[SHIFT(-1,-1,0)];
				tmp += 0.4218750 * ptr[SHIFT(-1,-1,-1)];
				res += tmp * 0.1250000;
			}
			{// u_coord=(2*I,2*J - 1,2*K - 1)
				data_t tmp = 0.0;
				const data_t * ptr = AF[F_IDX(2*I,2*J - 1,2*K - 1)];
				tmp += 0.0156250 * ptr[SHIFT(-1,0,0)];
				tmp += 0.0468750 * ptr[SHIFT(-1,0,-1)];
				tmp += 0.0468750 * ptr[SHIFT(-1,-1,0)];
				tmp += 0.1406250 * ptr[SHIFT(-1,-1,-1)];
				res += tmp * 0.1250000;
			}
			{// u_coord=(2*I - 1,2*J,2*K - 1)
				data_t tmp = 0.0;
				const data_t * ptr = AF[F_IDX(2*I - 1,2*J,2*K - 1)];
				tmp += 0.0156250 * ptr[SHIFT(0,-1,0)];
				tmp += 0.0468750 * ptr[SHIFT(0,-1,-1)];
				tmp += 0.0468750 * ptr[SHIFT(-1,-1,0)];
				tmp += 0.1406250 * ptr[SHIFT(-1,-1,-1)];
				res += tmp * 0.1250000;
			}
			...
			{// u_coord=(2*I,2*J,2*K - 1)
				...
				tmp += 0.0156250 * ptr[SHIFT(-1,-1,0)];
				tmp += 0.0468750 * ptr[SHIFT(-1,-1,-1)];
				res += tmp * 0.1250000;
			}
			{// u_coord=(2*I - 1,2*J,2*K)
				data_t tmp = 0.0;
				const data_t * ptr = AF[F_IDX(2*I - 1,2*J,2*K)];
				tmp += 0.0156250 * ptr[SHIFT(0,-1,-1)];
				tmp += 0.0468750 * ptr[SHIFT(-1,-1,-1)];
				res += tmp * 0.1250000;
			}
		...
		if (CHECK_BDR(I - 1,J - 1,K)) {// ingb=1
			...
			{// u_coord=(2*I - 1,2*J - 1,2*K - 1)
				data_t tmp = 0.0;
				const data_t * ptr = AF[F_IDX(2*I - 1,2*J - 1,2*K - 1)];
				tmp += 0.0468750 * ptr[SHIFT(0,0,0)];
				tmp += 0.0156250 * ptr[SHIFT(0,0,-1)];
				tmp += 0.0468750 * ptr[SHIFT(0,0,1)];
				tmp += 0.1406250 * ptr[SHIFT(0,-1,0)];
				tmp += 0.0468750 * ptr[SHIFT(0,-1,-1)];
				tmp += 0.1406250 * ptr[SHIFT(0,-1,1)];
				tmp += 0.1406250 * ptr[SHIFT(-1,0,0)];
				tmp += 0.0468750 * ptr[SHIFT(-1,0,-1)];
				tmp += 0.1406250 * ptr[SHIFT(-1,0,1)];
				tmp += 0.4218750 * ptr[SHIFT(-1,-1,0)];
				tmp += 0.1406250 * ptr[SHIFT(-1,-1,-1)];
				tmp += 0.4218750 * ptr[SHIFT(-1,-1,1)];
				res += tmp * 0.1250000;
			}
		...
		if (CHECK_BDR(I,J - 1,K - 1)) {// ingb=3
			...
			{// u_coord=(2*I - 1,2*J - 1,2*K - 1)
				...
				const data_t * ptr = AF[F_IDX(2*I - 1,2*J - 1,2*K - 1)];
				tmp += 0.0468750 * ptr[SHIFT(0,0,0)];
				tmp += 0.1406250 * ptr[SHIFT(0,0,-1)];
				tmp += 0.1406250 * ptr[SHIFT(0,-1,0)];
				tmp += 0.4218750 * ptr[SHIFT(0,-1,-1)];
				tmp += 0.0156250 * ptr[SHIFT(-1,0,0)];
				tmp += 0.0468750 * ptr[SHIFT(-1,0,-1)];
				tmp += 0.0468750 * ptr[SHIFT(-1,-1,0)];
				tmp += 0.1406250 * ptr[SHIFT(-1,-1,-1)];
		...
		if (CHECK_BDR(I,J - 1,K)) {// ingb=4
			...
			{// u_coord=(2*I - 1,2*J - 1,2*K - 1)
				data_t tmp = 0.0;
				const data_t * ptr = AF[F_IDX(2*I - 1,2*J - 1,2*K - 1)];
				tmp += 0.1406250 * ptr[SHIFT(0,0,0)];
				tmp += 0.0468750 * ptr[SHIFT(0,0,-1)];
				tmp += 0.1406250 * ptr[SHIFT(0,0,1)];
				tmp += 0.4218750 * ptr[SHIFT(0,-1,0)];
				tmp += 0.1406250 * ptr[SHIFT(0,-1,-1)];
				tmp += 0.4218750 * ptr[SHIFT(0,-1,1)];
				tmp += 0.0468750 * ptr[SHIFT(-1,0,0)];
				tmp += 0.0156250 * ptr[SHIFT(-1,0,-1)];
